#Source will be about person, age and favorite movie
#Make 2 list: Name and Favorite Movie
#Age can be random number
#main class will import this information


user_name = ['Sally', 'Mary', 'Susan', 'Joe', 'James',
             'Robert', 'John', 'Michael', 'William', 'Thomas',
             'Nancy', 'Lisa', 'Betty', 'Sandra', 'Emily',
...
favorite_movie = ['Robocop', 'Terminator', 'Aliens', 'Alien', 'The 400 Blows',
                  ...
                  'White heat', 'Eddie Murphy: Raw', 'All Quiet on the Western Front',
                  'Duck Soup', 'Mafioso', 'Stalag 17', 'The Shawshank Redemption', 'The Dark Knight',
